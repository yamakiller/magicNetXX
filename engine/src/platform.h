...
#define NS_CC_U_BEGIN        \
  NS_CC_BEGIN namespace util \
  {
...
#define NS_CC_O_BEGIN             \
  NS_CC_BEGIN namespace operation \
  {
...
#define NS_CC_M_BEGIN          \
  NS_CC_BEGIN namespace module \
  {
...
#define NS_CC_A_BEGIN       \
  NS_CC_BEGIN namespace api \
  {
...
#define NS_CC_L_BEGIN       \
  NS_CC_BEGIN namespace log \
  {
...
#define NS_CC_LL_BEGIN         \
  NS_CC_BEGIN namespace lualib \
  {
