...
#define MESSAGE_SOCKET_DATA 1
#define MESSAGE_SOCKET_CLOSE 2
#define MESSAGE_SOCKET_ACCEPT 3
#define MESSAGE_SOCKET_ERROR 4
#define MESSAGE_SOCKET_EXIT 5
#define MESSAGE_SOCKET_UDP 6
#define MESSAGE_SOCKET_WARNING 7
...
public:
  ...
  static int32_t connect(wsocket_t sock, const char *ip, int32_t port);
  static int32_t connectI(wsocket_t sock, int32_t ip, int32_t port);
  static int32_t listen(wsocket_t sock, int32_t que);
  static wsocket_t accept(wsocket_t sock);
  ...
  static int32_t getPeerInfo(wsocket_t sock, int32_t *ip, int32_t *port);
  static int32_t getSockInfo(wsocket_t sock, int32_t *ip, int32_t *port);
